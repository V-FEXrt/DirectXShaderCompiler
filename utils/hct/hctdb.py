...
class db_dxil(object):
    ...
    def populate_categories_and_models_ExperimentalOps(self):
        ...
        for i in insts(
            ...
            + "LinAlgMatrixLoadFromDescriptor,LinAlgMatrixAccumulateToDescriptor,"
            + "LinAlgMatVecMul,LinAlgMatVecMulAdd,LinAlgMatrixOuterProduct"
        ):
    ...
    def populate_ExperimentalOps(self):
        ...
        # Linear Algebra Ops
        op_table.reserve_dxil_op_range("LinAlgMatrixReserved", 1)
        ...
        add_dxil_op(
            ...
            [
                db_dxil_param(0, "$x0", "", "resulting matrix"),
                db_dxil_param(2, "$x1", "srcMatrix", "matrix to copy copy from"),
        ...
        add_dxil_op(
            ...
            [
                db_dxil_param(0, "v", "", ""),
                db_dxil_param(2, "$x0", "matrixRef", "Accumulator matrix"),
                # TODO: [Ty] * addrspace(4),   ; groupshared T[M * N]
                db_dxil_param(
        ...
        op_table.reserve_dxil_op_range("LinAlgMatrixReserved", 3, 1)
