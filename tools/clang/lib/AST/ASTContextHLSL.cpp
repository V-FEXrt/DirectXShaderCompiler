...
CXXRecordDecl *hlsl::DeclareLinAlgMatrixType(ASTContext &Context) {
  ...
  // Add the implicit HLSLLinAlgMatrixAttr attribute to unambiguously recognize
  // the builtin __builtin_LinAlg_Matrix type.
  RecordDecl->addAttr(HLSLLinAlgMatrixAttr::CreateImplicit(Context));
  RecordDecl->setImplicit(true);
