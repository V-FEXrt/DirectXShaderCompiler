...
void main() {
  ...
  // CHECK-SAME: (i32 -2147483619, i1 true, <4 x float> {{.*}}, <4 x float> {{.*}})  ; LinAlgMatrixOuterProduct(isSigned,vectorA,vectorB)
  ...
  // CHECK-SAME: (i32 -2147483619, i1 true, <4 x double> {{.*}}, <4 x double> {{.*}})  ; LinAlgMatrixOuterProduct(isSigned,vectorA,vectorB)
  ...
  // CHECK-SAME: (i32 -2147483619, i1 true, <4 x i64> {{.*}}, <4 x i64> {{.*}})  ; LinAlgMatrixOuterProduct(isSigned,vectorA,vectorB)
