...
// CHECK-SAME: i32 -2147483636, i1 true, float 1.500000e+00)  ; LinAlgFillMatrix(isSigned,value)
...
// CHECK-SAME: i32 -2147483636, i1 true, i32 45)  ; LinAlgFillMatrix(isSigned,value)
...
// CHECK-SAME: i32 -2147483636, i1 false, i32 45)  ; LinAlgFillMatrix(isSigned,value)
...
// CHECK-SAME: i32 -2147483636, i1 true, i32 13)  ; LinAlgFillMatrix(isSigned,value)
...
// CHECK-SAME: i32 -2147483636, i1 true, float 2.500000e+00)  ; LinAlgFillMatrix(isSigned,value)
...
// CHECK-SAME: i32 -2147483636, i1 true, i32 23)  ; LinAlgFillMatrix(isSigned,value)
...
// CHECK-SAME: i32 -2147483636, i1 true, i32 7)  ; LinAlgFillMatrix(isSigned,value)
