...
define void @mainHS() {
  ...
  call void @dx.op.linAlgVectorAccumulateToDescriptor.v16f16(i32 -2147483617, %dx.types.Handle %11, i32 0, i32 64, i1 true, <16 x half> %7)  ; LinAlgVectorAccumulateToDescriptor(handle,offset,align,isSigned,vector)
  ...
  %19 = call %dx.types.LinAlgMatrixC8M16N16U0S1 @dx.op.linAlgFillMatrix.mC8M16N16U0S1.f32(i32 -2147483636, i1 true, float 0x40091EB860000000)  ; LinAlgFillMatrix(isSigned,value)
...
; Function Attrs: nounwind
declare void @dx.op.linAlgVectorAccumulateToDescriptor.v16f16(i32, %dx.types.Handle, i32, i32, i1, <16 x half>) #1
