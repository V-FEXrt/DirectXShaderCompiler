...
define void @main() {
  ...
  %1 = call %dx.types.LinAlgMatrixC8M4N4U2S0 @dx.op.linAlgFillMatrix.mC8M4N4U2S0.i32(i32 -2147483636, i1 true, i32 1)  ; LinAlgFillMatrix(isSigned,value)
  ...
  ; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgFillMatrix.mC8M4N4U2S0.f32
  %badSigned = call %dx.types.LinAlgMatrixC8M4N4U2S0 @dx.op.linAlgFillMatrix.mC8M4N4U2S0.f32(i32 -2147483636, i1 false, float 1.0)  ; LinAlgFillMatrix(isSigned,value)
