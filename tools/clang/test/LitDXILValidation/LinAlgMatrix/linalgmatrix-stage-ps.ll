...
define void @mainPS() {
  ...
  %8 = call %dx.types.LinAlgMatrixC8M16N16U2S0 @dx.op.linAlgMatrixOuterProduct.mC8M16N16U2S0.v16f16.v16f16(i32 -2147483619, i1 true, <16 x half> %6, <16 x half> %6)  ; LinAlgMatrixOuterProduct(isSigned,vectorA,vectorB)
  ...
  call void @dx.op.linAlgVectorAccumulateToDescriptor.v16f16(i32 -2147483617, %dx.types.Handle %10, i32 0, i32 64, i1 true, <16 x half> %6)  ; LinAlgVectorAccumulateToDescriptor(handle,offset,align,isSigned,vector)
  ...
  %18 = call %dx.types.LinAlgMatrixC8M16N16U0S1 @dx.op.linAlgFillMatrix.mC8M16N16U0S1.f32(i32 -2147483636, i1 true, float 0x40091EB860000000)  ; LinAlgFillMatrix(isSigned,value)
