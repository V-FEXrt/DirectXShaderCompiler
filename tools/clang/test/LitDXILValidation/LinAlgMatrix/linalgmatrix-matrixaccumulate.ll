...
define void @main() {
  %1 = call %dx.types.LinAlgMatrixC8M4N4U2S2 @dx.op.linAlgFillMatrix.mC8M4N4U2S2.i32(i32 -2147483636, i1 true, i32 1)  ; LinAlgFillMatrix(isSigned,value)
  %2 = call %dx.types.LinAlgMatrixC8M4N4U0S2 @dx.op.linAlgFillMatrix.mC8M4N4U0S2.i32(i32 -2147483636, i1 true, i32 2)  ; LinAlgFillMatrix(isSigned,value)
  %3 = call %dx.types.LinAlgMatrixC8M4N4U2S0 @dx.op.linAlgFillMatrix.mC8M4N4U2S0.i32(i32 -2147483636, i1 true, i32 4)  ; LinAlgFillMatrix(isSigned,value)
  %4 = call %dx.types.LinAlgMatrixC8M4N4U1S0 @dx.op.linAlgFillMatrix.mC8M4N4U1S0.i32(i32 -2147483636, i1 true, i32 5)  ; LinAlgFillMatrix(isSigned,value)
  %5 = call %dx.types.LinAlgMatrixC8M4N4U1S1 @dx.op.linAlgFillMatrix.mC8M4N4U1S1.i32(i32 -2147483636, i1 true, i32 6)  ; LinAlgFillMatrix(isSigned,value)
  %6 = call %dx.types.LinAlgMatrixC8M8N8U0S2 @dx.op.linAlgFillMatrix.mC8M8N8U0S2.i32(i32 -2147483636, i1 true, i32 7)  ; LinAlgFillMatrix(isSigned,value)
